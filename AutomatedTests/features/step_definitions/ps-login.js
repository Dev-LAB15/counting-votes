...
When('I enter my correct email address', function (callback) {
...
Then('I receive an email with the verification code', function (callback) {
    // Write code here that turns the phrase above into concrete actions
    callback(null, 'pending');
});

Given('that I have received the verification code', function (callback) {
    // Write code here that turns the phrase above into concrete actions
    callback(null, 'pending');
});
...
Then('I\'m successfully logged in', function (callback) {
    // Write code here that turns the phrase above into concrete actions
    callback(null, 'pending');
});
